...
import com.yogesh.twitterdemo.network.UserRepository
import com.yogesh.twitterdemo.network.UserRepositoryRemote
    ...
    override fun getHomeTweets(userId: Long) {
        ...
        presenterScope.launch {
            try {
                // get the user tweets
                val tweets =
                    userRepository.getUserTweetsAsync(userId,
                        TWEETS_COUNT
                    )
