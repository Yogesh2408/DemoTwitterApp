package com.yogesh.twitterdemo.adapter
...
import com.yogesh.twitterdemo.extras.highlightClickable
import com.yogesh.twitterdemo.extras.summarizeCountNumber
...
class TweetsAdapter(
    ...
    class ViewHolder(itemView: View) :
        ...
        private fun onRetweetClick(view: View, item: Status) {
            ...
            val green = ResourcesCompat.getColor(itemView.resources,
                R.color.green, null)
            val gray = ResourcesCompat.getColor(itemView.resources,
                R.color.gray_dark, null)
